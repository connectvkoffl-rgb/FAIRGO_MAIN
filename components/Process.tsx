...
const ProcessStep: React.FC<{ step: number, title: string, description: string, image: string }> = ({ step, title, description, image }) => (
    <div className="flex flex-col items-center text-center">
        ...
        <div className="relative p-6 bg-gray-900/50 border border-gray-800/70 rounded-lg backdrop-blur-sm w-full">
        ...
        <section className="py-20 px-4">
            <div className="container mx-auto">
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-white">Process is Result</h2>
                    <p className="mt-4 text-lg text-gray-400">The real outcome is only as strong as the system behind it.</p>
                </div>
