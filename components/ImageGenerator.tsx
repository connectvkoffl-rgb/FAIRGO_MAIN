        ...
        <section className="py-20 px-4 bg-black/20">
            <div className="container mx-auto">
                <div className="text-center mb-12">
                    <SectionTitle>AI Creations</SectionTitle>
                    <h2 className="text-4xl md:text-5xl font-bold text-white">Visualize Your AI Concept</h2>
                    <p className="mt-4 text-lg text-gray-400 max-w-2xl mx-auto">Use our AI to generate a unique, futuristic image based on your ideas.</p>
                </div>
