...
const FeatureCard: React.FC<{ icon: React.ReactNode, title: string, children: React.ReactNode }> = ({ icon, title, children }) => (
    <div className="relative p-6 bg-gray-900/50 border border-gray-800/70 rounded-lg backdrop-blur-sm">
        ...
        <section className="py-20 px-4">
            <div className="container mx-auto">
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-white">All features in one place</h2>
                    <p className="mt-4 text-lg text-gray-400 max-w-2xl mx-auto">Custom AI solutions, built for the bold innovators of tomorrow's world</p>
                </div>
